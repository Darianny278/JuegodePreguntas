                ...
                if (mButtonChoice1.getText() == mAnswer) {
                    try{
                       ...
                       punto=punto+1;
                        ...
                        Toast.makeText(QuizActivity.this, "Error "+e, Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void updateQuestion() {
        ...
        private void AlertGano () {
         CharSequence[] texto ={"Felicidades, pasaste de nivel"};
            AlertDialog.Builder alerta= new AlertDialog.Builder(QuizActivity.this);
            ...
            alerta.setItems(texto, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent i = new Intent(QuizActivity.this, Geografia.class);
                    i.putExtras(bundle);
                    startActivity(i);
                }
            });

...
public class QuizCine4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_cine4);
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mButtonChoice3.getText() == mAnswer) {
                    ...
                    Intent i = new Intent(QuizCine4.this, Cine.class);
                    i.putExtras(bundle);
                    startActivity(i);
                }
            }
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizCine4.this);

...
public class QuizDeporte2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_deportes2);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizDeporte2.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizDeporte2.this, Deportes.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

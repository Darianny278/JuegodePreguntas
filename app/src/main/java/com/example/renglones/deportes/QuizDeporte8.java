...
public class QuizDeporte8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_deportes8);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizDeporte8.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizDeporte8.this, Deportes.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

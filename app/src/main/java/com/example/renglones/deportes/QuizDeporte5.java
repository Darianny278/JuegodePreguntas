...
public class QuizDeporte5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_deportes5);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizDeporte5.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizDeporte5.this, Deportes.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

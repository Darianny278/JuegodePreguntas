...
public class DatabaseHelper extends SQLiteOpenHelper {
    private Context ctx;
    //String usuario="create table Usuario( id integer not null  primary key autoincrement, nombre TEXT,email TEXT UNIQUE, contraseña TEXT, activo byte, scoregeografia int,scorehistoria int,scoredeportes int,scorecine int,scoreciencias int,scoretotal int)";

...
import com.example.renglones.Ciencia.QuizCiencia2;
import com.example.renglones.Geografia.Geografia;
import com.example.renglones.Geografia.QuizActivity;
import com.example.renglones.R;

public class QuizHistoria1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_historia1);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizHistoria1.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizHistoria1.this, Historia.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

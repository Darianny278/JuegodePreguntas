...
public class QuizHistoria3 extends AppCompatActivity {
    ...
    private int mQuestionNumber = 10;
    CountDownTimer cm;
    private int puntaje ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_historia3);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizHistoria3.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizHistoria3.this, Historia.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

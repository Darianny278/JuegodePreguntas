...
public class QuizHistoria4 extends AppCompatActivity {
    ...
    private int mQuestionNumber = 15;
    CountDownTimer cm;
    private int puntaje ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_historia4);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizHistoria4.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizHistoria4.this, Historia.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });

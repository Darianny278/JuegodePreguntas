...
public class QuizHistoria8 extends AppCompatActivity {
    ...
    private int mQuestionNumber = 35;
    private int puntaje ;
    CountDownTimer cm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_historia8);
    ...
    private void AlertGano() {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(QuizHistoria8.this);
        ...
        alerta.setItems(texto, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(QuizHistoria8.this, Historia.class);
                i.putExtras(bundle);
                startActivity(i);
            }
        });
